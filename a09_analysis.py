...
if __name__ == '__main__':
    ...
    check_subm_distribution(SUBM_PATH + 'submission_se_resnet_val_loss_0.0474_val_acc_0.985.csv')
    check_subm_diff(SUBM_PATH + '0.991_equal_2_pwr_mean_hun_5_prod-ce..csv', SUBM_PATH + 'submission_se_resnet_val_loss_0.0474_val_acc_0.985.csv')
